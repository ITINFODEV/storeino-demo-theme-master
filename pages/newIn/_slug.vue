        ...
        <div class="shop_slug flex mb-2 mt-11 relative">
            ...
            <div class="w-full">
                <div class="bg-white">
                    ...
                    <div v-if="!loading.products && newIn.length == 0" class="flex justify-center items-center my-5">
                        <h1 class="py-3">{{ $settings.sections.shop.empty_text }}</h1>
                    </div>
                    <div class="flex flex-wrap">
                        <div v-for="(item, i) in newIn" :key="i" class="p-2" :class="gridClass">
...
export default {
    ...
    methods: {
        ...
        async getnewIn() {
            this.newIn = this.items.filter(function (elt) { return elt.tags[0] == "newArrival"; });
        },
    },
}
</script>
