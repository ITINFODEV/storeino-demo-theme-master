<template>
    <div class="container">
        ...
        <div class="products__font flex flex-wrap" v-if="item">
                ...
                <div class="p-2">
                    <div class="bg-white p-2">
                        ...
                        <div class="flex items-center justify-start mb-2" v-if="$settings.sections.product.reviews.active">
                         ...
                         <p>Vendor: {{ item.name }}</p>
                         <p v-if="!item.outStock.disabled">Availability: out of Stock</p>
                         <p v-else>Availability: In Stock</p>
                         <p>Product Type: {{ item.collections[0].name }}</p>
                         <br>
