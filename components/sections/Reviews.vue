                ...
                <div v-for="(review, index) in reviews.results" :key="index" class="w-full md:w-1/2">
                    <div class="bg-white shadow flex justify-between flex-col m-1 p-2 h-full rounded-md">
                        <div class="flex flex-col">
                            <div class="flex">
                                <div class="flex">
                                    <si-avatar :name="`${review.customer.firstname} ${review.customer.lastname}`">
                                    </si-avatar>
                                    <span class="m-1"></span>
                                    <div>
                                        <b class="capitalize">{{ `${review.customer.firstname}
                                        ...
                                        <div class="mb-1 flex">
                                            <span v-for="(star, i) in 5"
                                                ...
                                                <svg aria-hidden="true" focusable="false" data-prefix="fas"
                                                    ...
                                                    viewBox="0 0 576 512" class="w-5 h-5 translate">
